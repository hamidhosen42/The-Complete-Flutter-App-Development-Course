...
class PlacePrivacyPolicy extends StatelessWidget {
  const PlacePrivacyPolicy({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
             ...
             majorelleBlueButton("Continue", ()=>Get.toNamed(placeBookingOrder))
          ],
        ),
      ),
    );
